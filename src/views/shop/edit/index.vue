<template>
  <section class="container">
    <div class="page-head-wraper">
      <page-head content="店铺编辑" @back="goBack" />
    </div>
    ...
    <div class="wraper">
      ...
      >
        ...
        <el-form-item label="店铺名称">
          <el-input v-model.trim="content.name" placeholder="输入店铺名称" />
        </el-form-item>
        <el-form-item label="店铺标语">
          <el-input v-model.trim="content.price" class="slogan-input" placeholder="输入店铺标语" maxlength="40" />
        </el-form-item>
        ...
        <el-form-item label="店铺介绍">
          <el-input v-model="content.intro" type="textarea" class="intro" placeholder="输入店铺介绍" />
        </el-form-item>
        <el-form-item label="营业信息">
          <el-input v-model.trim="content.courseNumber" placeholder="例如：周一至周日 09:00-17:30" />
        </el-form-item>
